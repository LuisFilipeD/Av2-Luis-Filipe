...
public class Cliente extends JFrame implements ActionListener, KeyListener {
    ...
    public Cliente(String porta) throws IOException{
    ...
    public void conectar() throws IOException{
        ...
        socket = new Socket(this.txtIP.getText(),Integer.parseInt(txtPorta.getText()));
